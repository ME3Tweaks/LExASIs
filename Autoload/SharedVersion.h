...
#define ASI_NAME_A "Autoload Enabler"
#define ASI_NAME_W L"Autoload Enabler"
#define ASI_NAME_NO_SPACE_A "AutoloadEnabler"
#define ASI_NAME_NO_SPACE_W L"AutoloadEnabler"


#define ASI_VERSION 11
