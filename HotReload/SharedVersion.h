...
#define ASI_NAME_A "Hot Reload"
#define ASI_NAME_W L"Hot Reload"
#define ASI_NAME_NO_SPACE_A "HotReload"
#define ASI_NAME_NO_SPACE_W L"HotReload"


#define ASI_VERSION 2
#define ASI_DESCRIPTION "Hot Reload changes the file opening code to not lock files, allowing files to be edited while the game is running."
