...
#define ASI_NAME_A "Ace Slammer"
#define ASI_NAME_W L"Ace Slammer"
#define ASI_NAME_NO_SPACE_A "AceSlammer"
#define ASI_NAME_NO_SPACE_W L"AceSlammer"


#define ASI_VERSION 4
// String that appears in the file description and part of SPI
#define ASI_DESCRIPTION "Ace Slammer randomly reverses gravity before turning it extremely high, causing ragdolled pawns to slam into the ground at high force."
